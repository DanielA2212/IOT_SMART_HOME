...
button_topic = 'home/daniel/BUTTON' 
...
class ConnectionDock(QDockWidget):
    ...
    def __init__(self,mc):
        ...
        self.ePushtbtn.setStyleSheet("background-color: navy; color: white")
    ...
    def process_clicks(self):
        ...
        if self.click_counter == 1:
            message = "[BUTTON]: SINGLE CLICK"
        elif self.click_counter == 2:
            message = "[BUTTON]: DOUBLE CLICK"
        elif self.click_counter >= 3:
            message = "[BUTTON]: TRIPLE CLICK"
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        # set up main window
        self.setGeometry(30, 100, 300, 150) # Starting Position (x, y, width, height) 
